...
/**
 * @OA\Schema(
 *   description="StudioNews model",
 *   title="StudioNews",
 *   required={},
 *   @OA\Property(type="integer",description="id of StudioNews",title="id",property="id",example="1",readOnly="true"),
 *   @OA\Property(type="string",description="name of StudioNews",title="name",property="name",example="Macbook Pro"),
 *   @OA\Property(type="string",description="sku of StudioNews",title="sku",property="sku",example="MCBPRO2022"),
 *   @OA\Property(type="integer",description="price of StudioNews",title="price",property="price",example="99"),
 ...
 * @OA\Schema (
 *   schema="StudioNews",
 *   title="StudioNewss list",
 *   @OA\Property(title="data",property="data",type="array",
 *     @OA\Items(type="object",ref="#/components/schemas/StudioNews"),
 *   ),
 ...
 *
 * @OA\Parameter(
 *      parameter="StudioNews--id",
 *      in="path",
 *      name="StudioNews_id",
 *      required=true,
 *      description="Id of StudioNews",
 *      @OA\Schema(
 *          type="integer",
 *          example="1",
 *      )
 * ),
 */
class StudioNew extends BaseModel
{
    use HasFactory;
