...
/**
 * @OA\Schema(
 *   description="MovieNewsComentary model",
 *   title="MovieNewsComentary",
 *   required={},
 *   @OA\Property(type="integer",description="id of MovieNewsComentary",title="id",property="id",example="1",readOnly="true"),
 *   @OA\Property(type="string",description="name of MovieNewsComentary",title="name",property="name",example="Macbook Pro"),
 *   @OA\Property(type="string",description="sku of MovieNewsComentary",title="sku",property="sku",example="MCBPRO2022"),
 *   @OA\Property(type="integer",description="price of MovieNewsComentary",title="price",property="price",example="99"),
 ...
 *
 * @OA\Schema (
 *   schema="MovieNewsComentarys",
 *   title="MovieNewsComentarys list",
 *   @OA\Property(title="data",property="data",type="array",
 *     @OA\Items(type="object",ref="#/components/schemas/MovieNewsComentary"),
 *   ),
 ...
 *
 * @OA\Parameter(
 *      parameter="MovieNewsComentary--id",
 *      in="path",
 *      name="MovieNewsComentary_id",
 *      required=true,
 *      description="Id of MovieNewsComentary",
 *      @OA\Schema(
 *          type="integer",
 *          example="1",
 *      )
 * ),
 */
class MovieNewsComentary extends BaseModel
{
    use HasFactory;
    ...
    {
        if (isset($data['movie_news_id']))
            $query->whereMovieNewsId($data['movie_news_id']);
