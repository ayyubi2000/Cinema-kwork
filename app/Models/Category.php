 ...
 *   title="Category",
 *   required={},
 *   @OA\Property(type="integer",description="id of Category",title="id",property="id",example="1",readOnly="true"),
 *   @OA\Property(type="string",description="name of Category",title="name",property="name",example="Macbook Pro"),
 *   @OA\Property(type="string",description="sku of Category",title="sku",property="sku",example="MCBPRO2022"),
 *   @OA\Property(type="integer",description="price of Category",title="price",property="price",example="99"),
...
class Category extends BaseModel
{
    ...
    public function scopeFilter($query, $data)
    {
        ...
        if (isset($data['subCategory']))
            $query->whereNotNull('parent_id')->with('category');
    }
}